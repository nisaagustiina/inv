<div class="panel panel-headline">
		<div class="panel-heading">
			<h3 class="panel-title">Add Data Incoming</h3>
		</div>
		<div class="panel-body">
            <div class="pull-left">
                <button class="btn btn-success btn-xs" id="btnAdd"><i class="fa fa-plus"></i> Add</button>
				...
				<tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            data-satuan="<?=$i->unit?>"
                            data-supplier="<?=$i->vendor?>"
                            data-kty="<?=$i->qty?>"
                            data-group="<?=$i->group?>"
                            data-category="<?=$i->category?>"
                            data-tgl="<?=indo_date($i->date)?>"><i class="fa fa-eye"></i> Detail</a>
                            <a href="<?= site_url('stock/in/del/'.$i->id_stock.'/'.$i->id_item)?>" onclick="return confirm('Apakah yakin akan menghapus data ini?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a></td>
                    </tr>
                    <?php } ?>
                </tbody>							
			</table>
